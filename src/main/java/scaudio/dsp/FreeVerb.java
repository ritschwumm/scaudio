...
public final class FreeVerb {
	...
	private float[]	fVec5	= new float[2048];
...
//	private float	fslider2;
	...
	private float[]	fVec14	= new float[2048];
...
//		float fSlow4 = (1 - fSlow3);
		...
		for (int i = 0; i < count; i++) {
			...
			float fTemp3 = (((((((fRec22_0 + fRec20_0) + fRec18_0) + fRec16_0) + fRec14_0) + fRec12_0) + fRec10_0) + fRec8_0);
...
//			output0[i] = ((fSlow4 * fTemp1) + (fSlow3 * fRec1));
			...
			float fTemp4 = (((((((fRec46_0 + fRec44_0) + fRec42_0) + fRec40_0) + fRec38_0) + fRec36_0) + fRec34_0) + fRec32_0);
